...
<Card titulo ="Componente aninhados(ColoneElement)" cor="#82212e">
    <FamiliaClone nome="Simpson">
        <FamiliaMembroClone noome="Homer Jay"/>
           <FamiliaMembroClone noome="Marjorie"/>
              <FamiliaMembroClone noome="Bartolomew JoJo"/>
                 <FamiliaMembroClone noome="Lisa Marie"/>
                    <FamiliaMembroClone noome="Margareth"/>
    </FamiliaClone>
</Card>

<Card titulo ="Componente aninhados(Comunicação direta)" cor="#d1495b">
